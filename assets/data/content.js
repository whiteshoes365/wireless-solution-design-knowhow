        ...
        },
        {
          ...
          blocks: [
            ...
            { t: "table",
              ...
              rows: [
                ["RF 성능", "경쟁사 <b>공개 스펙은 측정 조건·치구 불명</b>이라 신뢰·재현 불가", "자사 <b>동일 치구로 경쟁 샘플 직접 실측</b>(조건 통일) / 미국은 <b>FCC OET 공개 시험성적서</b>의 도전출력·스퓨리어스 참고"],
      ...
      sections: [
        {
          ...
          blocks: [
            { t: "kv", rows: [
              ...
              ["지그 (치구, jig/fixture)", "현장에서 흔히 <b>'지그'</b>라 부름(문서 표기 '치구'와 동일어). 측정·조립·검사 시 대상을 <b>같은 위치·같은 접점·같은 조건</b>으로 고정·연결해 주는 전용 받침대. RF에선 커넥터/스프링 프로브 접촉·전원 연결의 반복성을 보장 — 지그가 나쁘면 양품도 불량으로 오판. 종류: 도전(導電) 지그(직접 접촉), 결합안테나/OTA 챔버, 양산 검사 지그"],
            ]},
          ]
        }
      ]
